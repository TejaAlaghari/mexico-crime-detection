...
path = "/home/jaden/Desktop/cs-12200-project/frontend/"
path_mini_db = "/home/jaden/Desktop/cs-12200-project/Data/mini_db/"
path_crime_db = "/home/jaden/Desktop/cs-12200-project/Data/mini_db/frontend_aux/"
...
def predictive_analytics_options():
    ...
    fyears = ["2017", "2018", "2019", "2020"]

    sql_querry = "SELECT DISTINCT year from crime where year >= 2008 and year <= 2011;"

    years = sql_options_reader(sql_querry, cursor_object)

    return render_template('predictive_analytics_options.html', crime_types_list=crime_types_list, years=years, fyears=fyears)
...
def sql_predictive_analytics_output():
    ...
    import sys
    sys.path.insert(0, '/home/jaden/Desktop/cs-12200-project/backend/')
    #import py_file
    import lasso_model
    ...
    df_actual1 = df_actual[['state_name', crime_type]]
    ...
    df_coeffs1_ascending = df_coeffs.sort_values('Coefficients', ascending=True)
    df_coeffs1_ascending = df_coeffs1_ascending[:20]

    df_coeffs1_descending = df_coeffs.sort_values('Coefficients', ascending=False)
    df_coeffs1_descending = df_coeffs1_descending[:20]

    if year > 2016:
        return render_template("predictive_analytics_foutput.html", data1=new_df_predicted.to_html(), data2=df_coeffs1_ascending.to_html(), data3=df_coeffs1_descending.to_html(), data4=mse)
    else:
